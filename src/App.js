...
this.stateModes = {
kStateActive:0,kTransitionOut:1,kTransitionIn:2
};
this.stateMode = this.stateModes.kStateActive;
this.screenTransition = null;
this.screenTransitions = [{
from:appStates.kStateIntro,to:appStates.kStateDeveloperSplash,out:true,transition:new ScreenTransitionFade(0.25,new Pixel32(255,255,255,0),new Pixel32(255,255,255,255))
},{
from:appStates.kStateIntro,to:appStates.kStateDeveloperSplash,out:false,transition:new ScreenTransitionFade(0.25,new Pixel32(255,255,255,255),new Pixel32(255,255,255,0))
},{
from:appStates.kStateDeveloperSplash,to:appStates.kStateMainMenu,out:true,transition:new ScreenTransitionFade(0.25,new Pixel32(255,255,255,0),new Pixel32(255,255,255,255))
},{
from:appStates.kStateDeveloperSplash,to:appStates.kStateMainMenu,out:false,transition:new ScreenTransitionFade(0.5,new Pixel32(255,255,255,255),new Pixel32(255,255,255,0))
}];
 ...
 */
var appStates = {
kStateIntro:0,kStateDeveloperSplash:1,kStateMainMenu:2,kStateLoadingStage:3,kStateInGame:4,kStateStageComplete:5,kStateYesNoDialog:6,kStateTutorialPage:7,kStateDialogue:8,kStoryBoardState:9
};
App.instance = null;
