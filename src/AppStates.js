...
this.restartDelay = 0;
var msg = {
id:App.Messages.kYesNoDialogMsg,question:ResourceDepot.getInstance().getString("STR_RETRY_OR_QUIT"),yes:ResourceDepot.getInstance().getString("STR_RETRY"),no:ResourceDepot.getInstance().getString("STR_EXIT_TO_MENU")
};
...
for(var i = 0; i < 3; i ++) render.drawParticle(this.titleImgs[1],this.cloudXPos + this.titleImgs[1].textureWidth * 2 * i,this.titleImgs[1].textureHeight - 150,0,2,2,1,new Pixel32(255,255,255),false);
...
kStateDisplayLocation:0,kStateStoryBoard1:1,kStateStoryBoard1a:2,kStateStoryBoard1b:3,kStateStoryBoard1c:4,kStateStoryBoard2:5,kStateStoryBoard2a:6,kStateStoryBoard2b:7,kStateStoryBoard2c:8,kStateStoryBoard3:9,kStateStoryBoard3a:10,kStateStoryBoard3b:11,kStateStoryBoard4:12,kStateMax:13
};
