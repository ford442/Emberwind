...
this.spawnType = null;
this.states = [Gremlin.states.kStateIdle,GremIdleState,Gremlin.states.kStateWalk,GremWalkState,Gremlin.states.kStateSwing,GremSwingState,Gremlin.states.kStateKnockedOut,GremKnockedOutState,Gremlin.states.kStateDamaged,GremDamagedState,Gremlin.states.kStateBurnt,GremBurntState,Gremlin.states.kStateStunned,GremStunnedState,//Gremlin.states.kStateSleeping, GremSleepingState,
Gremlin.states.kStateBasketSpawn,GremBasketSpawnState,Gremlin.states.kStateAwaken,GremAwakenState,Gremlin.states.kStateLaugh,GremLaughState,Gremlin.states.kStateJump,GremJumpState,Gremlin.states.kStateFall,GremFallState,//Gremlin.states.kStateBlock, GremBlockState,
...
Gremlin.states = {
kStateIdle:0,kStateWalk:1,kStateSwing:2,kStateKnockedOut:3,kStateDamaged:4,kStateBurnt:5,kStateStunned:6,kStateSleeping:7,kStateBasketSpawn:8,kStateAwaken:9,kStateLaugh:10,kStateJump:11,kStateFall:12,kStateBlock:13,kStateUnblock:14,kStateThrow:15,kStatePursue:16,kStateTossed:17,kStateBubbled:18
};
Gremlin.types = {
kGremStandard:0,kGremScout:1,kGremBouncer:2,kGremGuard:3,kGremWarrior:4,kGremThief:5
};
...
this.awarenessTrigger = new TriggerVolume("awareness",this.awarenessRect,this,createCallback(this.onAwareness,this),"enter","exit");
this.combatAwarenessTrigger = new TriggerVolume("combat_awareness",this.combatAwarenessRect,this,createCallback(this.onCombatAwareness,this),"enter","exit");
...
this.fsm.setState(Gremlin.states.kStateKnockedOut,tossed?Gremlin.messages.kPETossed:(fromLeft?Gremlin.messages.kPEHitFromLeft:- 1));
if(this.type == Gremlin.types.kGremThief){
...
this.bubblePopTrigger = new TriggerVolume("bubble_pop",new Rectf(- 35,- 70,35,0),this,creteCallback(this.onPopBubble,this),"pop");
...
if(abandonCurrent === undefined){
abandonCurrent = false;
}
