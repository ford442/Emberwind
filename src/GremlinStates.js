Gremlin.messages = {
kPEAnimStopped:0,kPEHitFromLeft:1,kPlayerEntered:2,kVillagerEntered:3,kWakeUpCall:4,kGremHighJump:5,kGremNewWalkTarget:6,kSuccessfulBlock:7,kIncomingBallRoll:8,kTossLow:9,kPETossed:10
};
// ----------------------------------------------------------------------------
/**
 * Gremlin idle state.
