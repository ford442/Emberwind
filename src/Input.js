...
this.touches[id] = {
move:false,x:Math.floor((x - this.offset.x) / this.scale),y:Math.floor((y - this.offset.y) / this.scale)
};
};
...
var Buttons = {
up:0,down:1,left:2,right:3,jump:4,attack:5,interact:6,esc:7,render:8,skip:9
};
...
16:Buttons.attack,17:Buttons.interact,27:Buttons.esc,32:Buttons.attack,37:Buttons.left,38:Buttons.up,39:Buttons.right,40:Buttons.down,82:Buttons.render
};
