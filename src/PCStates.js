var PCStates = {
kStateIdle:0,kStateWalk:1,kStateJump:2,kStateFall:3,kStateSwing:4,kStateKnockedOut:5,kStateClimb:6,kStateDamaged:7,kStateHide:8,kStateUnhide:9,kStateBarrelRollStart:10,kStateBarrelRoll:11,kStateBarrelRollEnd:12,kStatePickupBrownie:13,kStateSnuffExplode:14,kStateSprint:15,kStateStartShuffle:16,kStateShuffle:17,kStateEndShuffle:18,kStateTurnShuffle:19,kStateJumpAttack:20,kStateWhirlwind:21,kStateBarrelDropStart:22,kStateBarrelDrop:23,kStateBarrelDropEnd:24,kStateCaneFlurry:25,kStateDialogueEvent:26,kStateDrown:27,kStateChargeUp:28,kStateSlide:29,kMaxStates:30
};
var PCMessages = {
kTransitionedFromSprint:0,kAnimStopped:1,kAnimationEvent:2,kAlreadyHidden:3,kAttackBlocked:4,kCorpseSmacked:5,kBlasted:6
};
// ---------------------------------------------------------------------------
/**
...
var input = GameInput.instance;
if(input.held(Buttons.right)){ this.hForce = 220; }else if(input.held(Buttons.left)){ this.hForce = - 220; }
this.host.movement.SetDesiredVelocityHoriz(this.hForce);
this.hForce *= 0.9;
};
