...
TutorialTip.styles = {
kOldStyle:0,kNewStyle:1,kSkillBookStyle:2
};
...
for(var h = 0; h < 4; ++ h) for(var v = 0; v < 4; ++ v) if(this.tiles[h][v] != null){
...
for(var x = 0; x < 4; ++ x) for(var y = 0; y < 2; ++ y){
...
for(var h = 0; h < 4; ++ h) for(var v = 0; v < 2; ++ v) if(this.timeInState >= 1.25){
